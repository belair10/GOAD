...
echo "[+] update windows_11_24h2_proxmox_cloudinit.pkvars.hcl"
sed -i "s/\"sha256:.*\"/\"sha256:$sha_win11\"/g" windows_11_24h2_proxmox_cloudinit.pkvars.hcl
...
echo "[+] Build iso winserver2025 with cloudinit"
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_winserver2025_cloudinit.iso answer_files/2025_proxmox_cloudinit
sha_winserv2025=$(sha256sum ./iso/Autounattend_winserver2025_cloudinit.iso|cut -d ' ' -f1)
echo "[+] update windows_server2025_proxmox_cloudinit.pkvars.hcl"
sed -i "s/\"sha256:.*\"/\"sha256:$sha_winserv2025\"/g" windows_server2025_proxmox_cloudinit.pkvars.hcl

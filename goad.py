...
class Goad(cmd.Cmd):
    ...
    def do_stop(self, arg=''):
        if self.lab_manager.get_current_instance_provider():
            self.lab_manager.get_current_instance_provider().stop(self.lab_manager.get_vm_ids())
...
def parse_args():
    ...
    parser.add_argument("-l", "--lab", help="lab to use", default='', required=False)
    parser.add_argument("-p", "--provider", help="provider to use", default='', required=False)
    parser.add_argument("-ip", "--ip_range", help="ip range to use", default='', required=False)
    parser.add_argument("-m", "--method", help="deploy method to use", default='', required=False)
